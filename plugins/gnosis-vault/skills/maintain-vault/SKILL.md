...
2. Audit frontmatter, links, indexes, logs, orphan pages, near-duplicate identities, stale summaries, and conflicting claims.
...
4. Regenerate indexes with `gnosis index -vault <root>` and record material repairs in the nearest `log.md`.
