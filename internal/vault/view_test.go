...
`)
	...
	expected := []string{
		...
		"gnosis://core/concepts/openspec-design.md",
		"gnosis://core/concepts/openspec-proposal.md",
		"gnosis://core/concepts/openspec-spec.md",
		"gnosis://core/concepts/openspec-tasks.md",
