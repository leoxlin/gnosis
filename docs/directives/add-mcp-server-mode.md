...
- [Add pgvector semantic knowledge backend](gnosis://core/directives/add-pgvector-knowledge-backend.md) @ `sha256:85637bfd1e30d4ac5dbea7440e37c793c5c69ad6616949562a166855a6db0ade` — supplies the open semantic retrieval contract.
- [Reshape CLI around resource verbs](gnosis://core/directives/reshape-cli-around-resource-verbs.md) @ `sha256:11869845b9c31453df075ee22a94c8013394a5d04e41eaabc5751cbff7bee112` — supplies the open final command tree, context propagation, and search defaults.
