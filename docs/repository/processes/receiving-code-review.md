...
4. If feedback conflicts with an active Repository Decision, stop and present the conflict to the author. Invoke `record-decision` only after the author settles a replacement choice; do not silently override durable knowledge.
