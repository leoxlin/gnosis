...
Selecting this process is an explicit request to create a Repository Directive.
...
- The Repository Directive definition.
...
5. Create a Repository Directive with `status: open`, the goal, bounded scope, links to governing decisions, an ordered `# Implementation plan`, and observable acceptance criteria. The directive is the single source of implementation requirements.
