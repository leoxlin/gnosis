...
* The [Gnosis purpose](/repository/purpose.md) and repository ontology ([Repository Purpose](/ontology/repository-purpose.md), [Repository Decision](/ontology/repository-decision.md), [Repository Directive](/ontology/repository-directive.md), [Repository Delta](/ontology/repository-delta.md)) are defined as OKF concepts.
...
* [Gnosis purpose](/repository/purpose.md)
