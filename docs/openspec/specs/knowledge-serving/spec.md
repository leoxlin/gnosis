# knowledge-serving Specification

## Purpose
Define read-only HTTP and MCP access to current gnosis vault knowledge with isolated protocol channels and graceful shutdown.
## Requirements
