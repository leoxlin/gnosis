...
5. After three failed fix attempts, stop and question the architecture with the author. Invoke `gnosis process invoke --id 'gnosis://core/procedures/planning/refining-requirements.md' --pretty` with the existing evidence before changing the design.
