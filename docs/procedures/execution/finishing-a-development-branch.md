...
1. Invoke `gnosis procedure invoke --uri 'gnosis://core/procedures/execution/verification-before-completion.md'` across the full suite, build, documentation checks, and every directive acceptance criterion. Stop on failure.
